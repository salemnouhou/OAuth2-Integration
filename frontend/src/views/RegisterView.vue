<template>
    <div class="container mx-auto">
       ...
       <div>
            <h1 class="font-black flex justify-center">Register to Sam Oauth2</h1>
            ...
            <input v-model="name" class="focus:outline-none focus:ring focus:border-orange-300 bg-gray-100 h-8 border-2 rounded-2xl w-full mt-8 p-2" type="text" placeholder="Name">
            <input v-model="email" class= "focus:outline-none focus:ring focus:border-orange-300 bg-gray-100 h-8 border-2 rounded-2xl w-full mt-4 p-2" type="text" placeholder="Email">
            <input v-model="password" class=" focus:outline-none focus:ring focus:border-orange-300 bg-gray-100 h-8 border-2 rounded-2xl w-full mt-4 p-2" type="password" placeholder="Password">
           
             
            
                <div>
                    <button class="border-0 p-1 w-full mt-4 rounded-full text-white bg-orange-600">Sign Up</button>
                </div>
            </form>
                <div class="border-2 mt-8 border-l-0 border-r-0 border-b-0 mb-3    w-full">
                    <span class=" -top-3 -right-1/3 relative flexflex justify-center text-gray-400 mt-5 text-sm ">Or register with</span>
                </div>
    ...
    <path fill="#ff5722" d="M6 6H22V22H6z" transform="rotate(-180 14 14)"></path><path fill="#4caf50" d="M26 6H42V22H26z" transform="rotate(-180 34 14)"></path><path fill="#ffc107" d="M26 26H42V42H26z" transform="rotate(-180 34 34)"></path><path fill="#03a9f4" d="M6 26H22V42H6z" transform="rotate(-180 14 34)"></path>
                ...
                <div class="flex justify-center">
                   ...
                   Already have an account ? <router-link to="login"><span class="flex justify-center mt-2 text-sm cursor-pointer  text-orange-600 ">Sign in now</span></router-link> 
                </div>
                </div>
       </div>
...
const errorMessage = ref(''); 
  ...
  try {
    const response = await fetch(import.meta.env.VITE_API_REGISTER, options);
    if (response.ok) {
